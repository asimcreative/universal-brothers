    ...
    'sections' => [
        ...
        'website-content' => [
            ...
            'steps' => [
                ...
                '"Website Content" covers pages (built from sections, such as About Us), saved sections, news, FAQs, testimonials, the media gallery and homepage sliders.',
            ...
            'example' => 'To change the About Us text, open Website Content → Pages, click "Edit" beside About Us, open the story section, change the text, then press "Publish changes".',
            'tips' => [
        ...
        'pages-builder' => [
            'title' => 'Building a page from sections',
            'group' => 'website',
            'icon' => 'bi-grid-1x2',
            'summary' => 'Create a website page by stacking ready-made sections — a banner, text, photos, packages, questions, a contact form — and arrange them without any coding.',
            'why' => 'Sections look like the rest of the website automatically, so a new page is professional from the start. Your changes stay in a draft until you publish, so visitors never see a half-finished page.',
            'steps' => [
                'Open Website Content → Pages and press "New Page". Type the page title; the page address fills in by itself. Choose a starting layout and press "Create draft and start building".',
                'To add a section, press "Add a section" at the bottom (or "Add a section below" in a section\'s ⋮ menu). Search or browse the list and click the kind of section you want.',
                'Click a section\'s name to open it, then fill in its fields. Headings, text, buttons and photos all have plain labels and examples.',
                'To change the order, drag a section by its handle (the dotted grip on the left), use the up and down arrow buttons, or click the handle and press the up and down arrow keys on your keyboard.',
                'To copy a section, open its ⋮ menu and choose "Duplicate". The copy appears straight below it.',
                'To take a section off the page for now without losing it, press the eye button. Hidden sections are striped and are not shown to visitors.',
                'To remove a section, choose "Delete section" in its ⋮ menu and confirm. Press "Undo" straight afterwards if you change your mind.',
                'Press "Save draft" often. Press "Save & preview" to see the page exactly as visitors will, on desktop, tablet and phone sizes.',
                'When it looks right, press "Publish". To make it appear later, open the arrow next to Publish and choose "Schedule for later".',
                'The History tab keeps a copy each time you publish. "Restore as draft" brings an earlier version back for you to check and publish again.',
            ],
            'example' => 'Create "Hajj Preparation Guide" with the Information page layout: change the banner heading, write the guide in the Text section, choose a photo of pilgrims in the Text with image section, then Save & preview and Publish.',
            'tips' => [
                'Nothing you change reaches the website until you press Publish. "Save draft" is always safe.',
                'Changing the address of a live page breaks links people have saved. Change it only when you have to.',
                'Sections such as Hajj packages, Testimonials and Questions and answers always show the latest information, so you never have to update them on each page.',
                'Undo works for moving, hiding, duplicating, adding and deleting sections until you leave the page.',
            ],
            'faqs' => [
                ['I pressed Publish and it said the page was not published.', 'Your changes were saved as a draft. The red box at the top lists what needs fixing, and each item links to the right section. Fix them and press Publish again.'],
                ['Where did my About Us page go?', 'It is still there under Pages. The first time you edit it, its current text is turned into sections for you. The live page stays exactly the same until you publish.'],
                ['Can I undo after saving?', 'Undo works until you leave the page. After that, use the History tab to restore an earlier published version, or "Discard unpublished changes" in the More menu.'],
            ],
            'links' => [['Pages', 'admin.pages.index', []], ['New page', 'admin.pages.create', []], ['Saved sections', 'admin.content-blocks.index', []]],
        ],
        ...
        'text-editor' => [
            ...
            'group' => 'website',
            'icon' => 'bi-type',
            'summary' => 'The text editor works like a word processor: bold, headings, lists, links, tables, photos and videos, all from the toolbar.',
            'why' => 'Well-formatted text is easier for pilgrims to read. The editor gives you the formatting without typing any code, and the website removes anything unsafe when you save.',
            'steps' => [
                'Click inside the text box and type. Select words, then use the toolbar: B for bold, I for italic, U for underline.',
                'Choose "Heading" or "Subheading" from the Text style list to break long text into parts.',
                'Use the list buttons for bulleted or numbered lists — ideal for documents to bring or steps to follow.',
                'To add a link, select the words and press the link button (or Ctrl+K). Type a page of this website starting with a slash, such as /contact, or a full address starting with https://.',
                'In longer texts (pages and news) you can also insert a table, a photo from the media library, or a YouTube or Vimeo video.',
                'Press the full-screen button to write with more space. Press Esc to go back.',
                'The counter under the box shows the number of words. If it turns red, the text is too long — shorten it or split it into two sections.',
            ],
            'example' => 'In a note about documents, type "Documents to bring", make it a Subheading, then add a bulleted list: "Original passport", "Two photographs", "Vaccination certificate".',
            'tips' => [
                'Pasting from Word or a website keeps simple formatting. Colours, fonts and anything unsafe are removed when you save.',
                'Keyboard users: press Alt+F10 to reach the toolbar, then the arrow keys to move along it.',
                'Short fields such as prices, dates, room types and hotel names are not formatted text on purpose, so they stay correct everywhere they are used.',
            ],
            'faqs' => [
                ['Where does the editor appear?', 'In pages, news articles, FAQ answers, package descriptions, package notes and policies, Aziziya notes, Mina and Arafat notes, and saved notes under Reusable Content.'],
                ['My old text shows as one paragraph.', 'Older text keeps its line breaks. Open it in the editor, tidy it with headings and lists, and save.'],
            ],
            'links' => [['FAQs', 'admin.faqs.index', []], ['News', 'admin.news.index', []]],
        ],

        'images-alt-text' => [
            'title' => 'Images and image descriptions',
            'group' => 'website',
            'icon' => 'bi-image',
            'summary' => 'Upload a photo or choose one already in the media library, and describe it so everyone can understand it.',
            'why' => 'Some visitors use screen readers, and search engines cannot see pictures. A short description (called alt text) tells them what the photo shows.',
            'steps' => [
                'In a section or in the text editor, press "Choose image".',
                'To use a photo already uploaded, stay on "Media library", search if needed, and click the photo.',
                'To add a new one, open "Upload a new image", drag the photo in or click to choose it. JPG, PNG, WebP and GIF files up to 5 MB are accepted.',
                'Type a description of what the photo shows in "Image description", then press "Upload image" or "Use this image".',
                'To swap the photo, press "Replace image". To take it off the section, press "Remove" — the photo stays in the media library.',
                'All uploaded photos are listed under Website Content → Media Gallery, in the "Uploaded for pages and text" tab.',
            ],
            'example' => 'Description for a Mina photo: "Rows of white air-conditioned tents in Mina during Hajj". Not "IMG_2041" and not "photo".',
            'tips' => [
                'Describe what matters in one sentence. Do not start with "Image of".',
                'Banner and background photos do not need a description — the heading beside them already says what the section is about.',
                'Landscape photos at least 1200 pixels wide look best. Very large files are refused; phones can usually share a smaller size.',
                'Only use photos you have the right to use.',
            ],
            'faqs' => [
                ['Why was my file refused?', 'Only JPG, PNG, WebP and GIF photos up to 5 MB can be uploaded. Other kinds of files are refused to keep the website safe.'],
                ['Does deleting a photo from the media library remove it from pages?', 'Yes. If a page or text shows that photo, it disappears from there, so check before deleting.'],
            ],
            'links' => [['Media gallery', 'admin.media.index', []]],
        ],
        ...
        'reusable-sections' => [
            ...
            'summary' => 'Keep a section you use often — a Hajj call to action, trust figures, booking instructions — and insert it into any page.',
            'why' => 'Writing the same section again on every page takes time and the wording drifts apart. A saved section is written once and reused.',
            'steps' => [
                'In the page builder, open a section\'s ⋮ menu and choose "Save for reuse on other pages". Give it a name and a group.',
                'Or open Pages → Saved Sections → "New Saved Section" and choose the kind of section.',
                'To use it, press "Add a section" in any page, open the "Saved sections" tab and press "Insert a copy".',
                'A copy belongs to that page: change it freely, and no other page is affected.',
                'A super admin can instead press "Insert linked". A linked section always shows the saved section\'s latest content, so editing the saved section changes every page that links to it.',
                'To stop offering a saved section, archive it. A saved section that pages link to cannot be deleted until those links are removed.',
            ],
            'example' => 'Save the "Book your Hajj 2027" call-to-action banner, then insert a copy on the Hajj Services and Hajj Preparation Guide pages.',
            'tips' => [
                'Use "Insert a copy" unless you are sure every page should always change together.',
                'The saved section\'s edit screen lists every page that links to it before you save.',
            ],
            'faqs' => [
                ['I changed a saved section but a page did not change.', 'That page has a copy, not a link. Edit the section on the page itself, or replace it with a linked section.'],
                ['The Save button is greyed out on a saved section.', 'Pages link to that saved section, so saving would change them straight away. Only a super admin can change it. Duplicate it from the Saved sections list and change your copy instead.'],
            ],
            'links' => [['Saved sections', 'admin.content-blocks.index', []]],
        ],

        'page-search-sharing' => [
            'title' => 'Search results and sharing',
            'group' => 'website',
            'icon' => 'bi-search',
            'summary' => 'Choose how a page looks on Google and when its link is shared on WhatsApp or Facebook.',
            'why' => 'A clear title and description help people choose your page in search results and in chats.',
            'steps' => [
                'Open the page, then the "Search & sharing" tab.',
                'Write a "Title in search results" (about 50–60 characters) and a "Description in search results" (about 150–160 characters). The counters help.',
                'Watch the Google preview on the right update as you type.',
                'Optionally type the main search phrase; the tips below it show whether it appears in your title, description and text.',
                'Open "Sharing on WhatsApp and Facebook" to set a different title, description or photo for shared links.',
                'Switch on "Hide this page from search engines" for pages that should only be reached by a link.',
            ],
            'example' => 'Title: "Hajj Preparation Guide 2027 | Universal Brothers". Description: "What to pack, which documents you need and how to prepare for Hajj 2027 — step by step from Universal Brothers."',
            'tips' => [
                'Leave the fields empty and the page title and the start of the text are used.',
                'Changes to search results can take days to show on Google.',
            ],
            'faqs' => [
                ['What is the canonical link?', 'Only needed when the same content is also published at another address. Leave it empty in almost every case.'],
            ],
            'links' => [['Pages', 'admin.pages.index', []]],
        ],

        'fixing-problems' => [
            'title' => 'When a page says something needs fixing',
            'group' => 'publishing',
            'icon' => 'bi-exclamation-triangle',
            'summary' => 'What the red and yellow boxes mean, and how to fix each kind of problem quickly.',
            'why' => 'Checks stop an unfinished or broken page reaching visitors — a button that goes nowhere, a missing photo, a section left empty.',
            'steps' => [
                'Read the box at the top of the page. Each line says which section, which field, and how to fix it.',
                'Click a line to jump straight to that field. The section opens and the field is marked in red.',
                'Yellow "Check these before publishing" items are warnings: your draft saved, but the page cannot be published until they are fixed.',
                '"Not a link the website can open": start a page of this website with a slash (/contact) or another website with https://.',
                '"Describe the image": type what the photo shows in its description box.',
                '"Is empty": fill the field, or delete the section if you do not need it.',
                '"Another page already uses this address": change the page address in the "Title & address" tab.',
            ],
            'example' => 'The box says "Section 3 (Call-to-action banner): Button link “www.hajj.com” is not a link the website can open. Add https:// at the start". Click it, change the link to https://www.hajj.com and press Publish again.',
            'tips' => [
                'What you typed is never thrown away when a check fails.',
                'Hidden sections are not checked until you show them again.',
            ],
            'faqs' => [
                ['I cannot find the field that has the problem.', 'Click the line in the red box: it opens the right tab and section and scrolls to the field.'],
            ],
            'links' => [['Pages', 'admin.pages.index', []]],
        ],
        ...
        'settings' => [
            ...
            'example' => '"Years of experience" — 20+. "Hajj licence number" — exactly as printed on the licence.',
            'tips' => [
        ...
        'ai-assistant' => [
            ...
            'steps' => [
                'Open AI Assistant. "On or off" switches the assistant on, chooses whether visitors see it, and sets its name, button icon and welcome message.',
                '"Provider and key" shows whether a key is saved. Only its first and last characters are ever shown. Press "Check the key works" to test it safely.',
                'To change the key, paste the new key into "Replace the API key" and press "Save settings". Leaving the box empty keeps the saved key.',
                '"How it answers" sets the style (keep it towards Precise), the longest answer and any extra instructions.',
                '"Limits and logging" sets how many messages one visitor can send per day (currently 50).',
                'After changing FAQs or pages, press "Refresh what it knows" so the assistant has the latest information.',
                'Use "AI Test Panel" to ask it a question yourself, and "AI Conversations" to see what visitors asked.',
            ],
            ...
            'tips' => [
                ...
                'Never paste the key into the extra instructions, a message or an email. Only paste it into "Replace the API key".',
                'If you think the key has been seen by someone else, create a new key with your provider, replace it here, and delete the old one at the provider.',
            ],
            'faqs' => [
                ['The assistant says it cannot answer right now.', 'The account may be out of credit or the daily limit reached. Press "Check the key works" on the AI Assistant page; the message explains what is wrong.'],
                ['How do I safely update the API key?', 'Paste the new key into "Replace the API key", press "Save settings", then press "Check the key works". The old key is replaced and is never shown again.'],
            ],
