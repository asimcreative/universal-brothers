{{--
    ...
    template so our own stylesheet in `resources/css/site.css`
...
<section id="why-us" class="overflow-hidden bg-sand-300 py-16 sm:py-20 lg:py-24">
                        ...
                        <div class="reveal-on-scroll reveal-delay-1">
                            <div class="group flex gap-4">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="mt-1 text-sm leading-relaxed text-ink-400">Decades of specialized Hajj and Umrah expertise.</p>
                                </div>
                            </div>
                        </div>
                    </li>
                        ...
                        <div class="reveal-on-scroll reveal-delay-2">
                            <div class="group flex gap-4">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="mt-1 text-sm leading-relaxed text-ink-400">Thousands of pilgrims have travelled under our care.</p>
                                </div>
                            </div>
                        </div>
                    </li>
                        ...
                        <div class="reveal-on-scroll reveal-delay-3">
                            <div class="group flex gap-4">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="mt-1 text-sm leading-relaxed text-ink-400">Recognition for service and professional excellence.</p>
                                </div>
                            </div>
                        </div>
                    </li>
                        ...
                        <div class="reveal-on-scroll reveal-delay-4">
                            <div class="group flex gap-4">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="mt-1 text-sm leading-relaxed text-ink-400">Individual attention before, during and after the journey.</p>
                                </div>
                            </div>
                        </div>
                    </li>
                        ...
                        <div class="reveal-on-scroll reveal-delay-5">
                            <div class="group flex gap-4">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="mt-1 text-sm leading-relaxed text-ink-400">Professionals who understand the complexities of pilgrimage travel.</p>
                                </div>
                            </div>
                        </div>
                    </li>
                        ...
                        <div class="reveal-on-scroll reveal-delay-6">
                            <div class="group flex gap-4">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="mt-1 text-sm leading-relaxed text-ink-400">Assistance where it matters most throughout your sacred journey.</p>
                                </div>
                            </div>
                        </div>
                    </li>
