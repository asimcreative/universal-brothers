...
@if($awards->isNotEmpty())
    ...
    <section id="highlights"><h2 class="sr-only">Awards and recognitions</h2><div class="reveal-on-scroll"><div class="ub-marquee relative overflow-hidden bg-accent-500 py-4 sm:py-6"><div class="ub-marquee-track flex w-max flex-nowrap items-center text-ivory" style="--ub-marquee-duration: {{ $ubDuration }}s">@foreach([false, true] as $ubIsDuplicate)<div @if($ubIsDuplicate) aria-hidden="true" @endif class="flex shrink-0 flex-nowrap items-center">@foreach($ubHalf as $award)<span class="flex items-center"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-sparkle mx-6 shrink-0 text-heading/70 sm:mx-9" aria-hidden="true"><path d="M9.937 15.5A2 2 0 0 0 8.5 14.063l-6.135-1.582a.5.5 0 0 1 0-.962L8.5 9.936A2 2 0 0 0 9.937 8.5l1.582-6.135a.5.5 0 0 1 .963 0L14.063 8.5A2 2 0 0 0 15.5 9.937l6.135 1.581a.5.5 0 0 1 0 .964L15.5 14.063a2 2 0 0 0-1.437 1.437l-1.582 6.135a.5.5 0 0 1-.963 0z"></path></svg><span class="whitespace-nowrap font-display text-base font-bold tracking-wide text-heading sm:text-xl lg:text-[32px]">{{ $award->name }}</span></span>@endforeach</div>@endforeach</div></div></div></section>
@endif
