                    ...
                    @forelse($items as $item)
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <form method="POST" action="{{ route('admin.media.destroy', $item) }}" class="d-inline" data-confirm="This cannot be undone." data-confirm-title="Delete this media item?" data-confirm-button="Delete">
                                    @csrf @method('DELETE')
