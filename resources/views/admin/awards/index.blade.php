                    ...
                    @forelse($awards as $award)
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <form method="POST" action="{{ route('admin.awards.destroy', $award) }}" class="d-inline" data-confirm="This cannot be undone." data-confirm-title="Delete this award?" data-confirm-button="Delete">
                                    @csrf @method('DELETE')
