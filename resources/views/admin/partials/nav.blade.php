...
@php
    ...
    $groups = [
        'Hajj Packages' => [
            ...
            $link('admin.package-templates.index', 'admin.package-templates.*', 'bi-files', 'Package Templates'),
        ],
        'Reusable Content' => [
        ...
        'Company' => [
            ...
            $link('admin.settings.index', 'admin.settings.*', 'bi-gear', 'Site Settings'),
        ],
        'AI Assistant' => [
    ...
    $groups['Help'] = [
        $link('admin.help', 'admin.help', 'bi-life-preserver', 'How to use the admin'),
    ];
@endphp

<nav class="admin-nav-scroll" aria-label="{{ $label ?? 'Admin' }}">
    ...
    @foreach($groups as $group => $items)
        ...
        @foreach($items as $item)
            <a href="{{ $item['url'] }}" class="admin-nav-link {{ $item['active'] ? 'active' : '' }}" @if($item['active']) aria-current="page" @endif>
