...
|---|---|---|---|
| Pilgrims served | "10,000+ Hajis Served" / "10,000+ Pilgrims Served" (appears 4×) | `pilgrims_served` = **"50,000+"** | Recovered directly from the live `tourism.universalbrothers.com` homepage during an earlier audit pass (`SiteSettingSeeder.php`) |
| Awards count | "20+ Awards & Recognitions" (appears 3×, incl. a homepage stat tile) | `industry_awards_count` = **"7"**, and exactly **7 real, named** awards are on file (FPCCI Achievement Award, Who's Who Pakistan Award, Quality Standard Award, Best Hajj Operator — WHUC London Olympia, Consumers Choice Award, Brand Icon of Pakistan, Brands of the Year) | `AboutPageSeeder.php`, sourced from the live site audit |
