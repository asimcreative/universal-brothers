    ...
    private function packages(): array
    {
        return [
            ...
            [
                ...
                'medinah_first' => true, 'is_shifting' => false,
                'variants' => ['A' => 'Dar Al Taqwa/Hilton', 'B' => 'Taibah Front'],
                'itinerary' => [
                ...
                'accommodations' => [
                    ...
                    ['medinah', 'B', 'Taibah Front / Similar', 3, 3],
            ...
            [
                ...
                'medinah_first' => true, 'is_shifting' => false,
                'variants' => ['A' => 'Dar Al Taqwa', 'B' => 'Taibah Front'],
                'itinerary' => [
                ...
                'accommodations' => [
                    ...
                    ['medinah', 'B', 'Taibah Front / Similar', 3, 2],
            ...
            [
                ...
                'room_options' => [
                    ...
                    ['A', 'quad', 4, 'Quad Sharing', 13850],
                    ['A', 'triple', 3, 'Triple Sharing', 15200],
                    ['A', 'double', 2, 'Double Sharing', 18220],
                    ['B', 'sharing_room', null, 'Sharing Room', 13000],
                    ['B', 'quad', 4, 'Quad Sharing', 13000],
                    ['B', 'triple', 3, 'Triple Sharing', 14650],
                    ['B', 'double', 2, 'Double Sharing', 17400],
                ],
            ],
            [
                ...
                'room_options' => [
                    ['A', 'sharing_room', null, 'Sharing Room', null],
                    ['A', 'quad', 4, 'Quad Sharing', 13550],
                    ['A', 'triple', 3, 'Triple Sharing', 14650],
                    ['A', 'double', 2, 'Double Sharing', 17400],
                    ['B', 'sharing_room', null, 'Sharing Room', 12750],
                    ['B', 'quad', 4, 'Quad Sharing', 12750],
                    ['B', 'triple', 3, 'Triple Sharing', 14390],
                    ['B', 'double', 2, 'Double Sharing', 16850],
                ],
            ],
            [
                ...
                'accommodations' => [
                    ['medinah', null, 'Taibah Front / Similar', 3, 3],
            ...
            [
                ...
                'accommodations' => [
                    ['medinah', null, 'Taibah Front / Similar', 3, 2],
            ...
            [
                ...
                'accommodations' => [
                    ...
                    ['medinah', 'B', 'Taibah Front / Similar', 3, 3],
                    ['makkah', null, 'Abraaj Tower / Swiss Maqam', 5, 4],
            ...
            [
                ...
                'accommodations' => [
                    ['medinah', 'A', 'Dar Al Taqwa', 5, 2],
                    ['medinah', 'B', 'Taibah Front / Similar', 3, 2],
                    ['makkah', null, 'Abraaj Tower / Swiss Maqam', 5, 2],
